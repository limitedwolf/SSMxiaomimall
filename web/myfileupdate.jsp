...
<script>
   ...
   var vue = new Vue({
       ...
       methods:{
           ...
           axios.post("/consumer/CheckLogin.do").then(res=>{
               console.log(res);
               this.form = res.data.objectMap.consumer;
               this.form.password = "";
           })},
              onSubmit() {
                  console.log("开始提交");
                  console.log(this.form);
                    axios.post("/consumer/updateprofile.do",this.form).then(res=>{
           ...
           timeclick(){
               ...
               var timer = setInterval(function(){
                   ...
                   if(time<0){
                       clearInterval(timer);
                       window.location.href="${pageContext.request.contextPath}/consumer/logout.do";
                   }
               });
           }
